    ...
    return [
        {
            ...
            "content_json": {
                ...
                "absentees": [],
                "observers": ["張公關"],
                "opening_remarks": "請各組先就暑期招生活動與迎新準備進行進度回報。",
                "reports": "總務組完成場地借用初步詢問，宣傳組已提出海報草稿。",
                "motions": "無。",
                "adjournment_time": "20:20",
                "agenda_items": [
                    {
                        "title": "暑期招生活動準備",
        ...
        },
        {
            ...
            "content_json": {
                ...
                "resource_needs": "投影設備、麥克風、簽到物資與茶點。",
                "notes": "示範用迎新活動企劃書。",
            },
        },
        {
                ...
                "improvement_actions": [
                    {
                        "issue": "報到動線",
                        "planned": "單一報到桌",
                        "actual": "18:00-18:20 排隊過長",
                        "problem": "入口動線與報到桌數量不足",
                        "action": "增設第二報到桌",
                        "owner": "李宣傳",
                        "deadline": "下次大型活動前",
                    },
        ...
        },
        {
            ...
            "content_json": {
                ...
                "academic_year": "114",
                "club_name": club_name,
                "club_purpose": "透過社團活動、行政運作與資料留存，建立可持續交接的社團文化。",
                ...
                "key_activities": [
                    ...
                    },
                    {
                        ...
                        "activity_type": "成果發表",
                        "target": "全校師生",
                        "expected_outcome": "展示年度成果與招生延伸",
                        "purpose": "展示年度成果",
                        "note": "",
                    },
                ],
                "cadre_assignments": [
                    {"role": "會長", "name": "林會長", "task": "年度規劃與對外協調"},
                    {"role": "活動長", "name": "王活動", "task": "活動企劃與執行"},
                    {"role": "文書", "name": "陳文書", "task": "會議紀錄與資料整理"},
                ],
